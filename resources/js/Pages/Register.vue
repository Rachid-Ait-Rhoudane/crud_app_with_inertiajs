...
<template>
    ...
    <div class="w-screen min-h-screen bg-main grid place-items-center">
        ...
        <div class="bg-white rounded-md space-y-10 w-[90%] sm:w-[450px] my-8">
            ...
            <form @submit.prevent="formInputs.post('/register')" class="flex flex-col gap-6">
                ...
                <div class="flex flex-col gap-1 px-6">
                    <FormInput @update-value="(val) => formInputs.password_confirmation = val" label="password confirmation" placeHolder="*******" input-type="text" />
